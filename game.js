...
(function(){
	...
	var mainState = {
		preload : function(){
			...
			this.game.load.image('bgSpace','assets/bakgrund.jpg');
			this.game.load.image('bgSpace2','assets/starfield.png');
			this.game.load.spritesheet('ship','assets/Spritesheet_64x29.png',64,29,4);
			this.game.load.spritesheet("enemyship1","assets/Spritesheet_40x30.png",40, 30, 6);
			this.game.load.spritesheet("enemyship2","assets/Spritesheet_40x30_hue1.png",40, 30, 6);
			this.game.load.spritesheet("enemyship3","assets/Spritesheet_40x30_hue2.png",40, 30, 6);
			this.game.load.spritesheet("enemyship4","assets/Spritesheet_40x30_hue3.png",40, 30, 6);
			this.game.load.spritesheet("enemyship5","assets/Spritesheet_40x30_hue4.png",40, 30, 6);
			this.game.load.audio('shootfx', 'assets/laser.wav');
		...
		create : function(){
			...
			var style = { font: "18px Arial", fill: "#222222", align: "left" };
			this.scoreText = this.game.add.text(665,6,"Score : "+this.score,style);
			this.livesText = this.game.add.text(665,28,"Lives : "+this.lives,style);
			
			this.shootsound = this.game.add.audio('shootfx');
			this.expsound = this.game.add.audio('explosion');
		},
		...
		update : function(){
			...
			{
				this.ship.body.velocity.y = -2*this.speed;
			}
	...
	var menuState = {
		preload : function(){
			this.game.load.image('bgSpace','assets/bakgrund.jpg');
			//se http://docs.phaser.io/Phaser.Sound.html
			this.game.load.audio('titlemusic', 'assets/Hekatonus.mp3', 0.3, true);
		...
		create : function(){
			...
			var style = { font: "48px Arial", fill: "#111111", align: "center" };
			this.title = this.game.add.text(250,170,"StarFox",style);

			var style2 = { font: "28px Arial", fill: "#111111", align: "center" };
			this.help = this.game.add.text(250,230,"Press Enter to start",style2);
		},
